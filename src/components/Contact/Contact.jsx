...
const Contact = () => {
  return (
    ...
    <div className="bg-gray-200 "> {/* Light Gray background */}
  <div
    className="relative bg-cover bg-center h-[65vh]"
    style={{ backgroundImage: `url(${connectimg})` }}
  >
    <div className="py-24 bg-gray-300 bg-opacity-40 h-[65vh]"> {/* Lighter Gray overlay */}
      <div className="max-w-md mx-16 text-center py-12 bg-gray-100 bg-opacity-50 rounded-tl-2xl rounded-br-2xl">
        <h1 className="text-4xl font-bold mb-4 text-gray-700">Welcome!</h1>
        <p className="text-2xl text-gray-600 mb-6 flex mx-6">
          <h3 className="animate-slideInLeft">Connect with Us - </h3>
          <h4 className="animate-slideInRight">Your Voice Matters</h4>
        </p>
        <a
          href="/contact"
          className="bg-green-500 text-gray-800 font-bold py-3 px-6 rounded-3xl shadow-lg hover:bg-green-600 transition duration-300"
        >
          Send a Message
        </a>
      </div>
  ...
  {/* Support Section */}
  <div className="bg-gray-300 py-12"> {/* Light Gray background */}
    <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
      <div className=" md:text-center">
        <h2 className=" text-gray-800 text-4xl font-bold mt-16">We're here to support</h2>
        <h3 className="text-gray-800 text-lg my-4">
          Your Dream, Our Expertise - Fill in Your Details, and Let's Get
          Started!
        </h3>
        <div className="bg-gray-100 rounded-tl-2xl rounded-br-2xl my-16 mx-28">
          <p className="text-gray-800 text-lg py-16 md:text-center">
            <span className="text-xl font-bold">Opening Times:</span>
            <br />
            <br />
      ...
      <div>
        ...
        <div className="bg-gray-100 p-6 rounded-tl-2xl rounded-br-2xl">
          <div className="relative">
            <select className="block w-full bg-gray-200 border-b-2 border-gray-300 p-2">
      ...
      <option value="13">Data Analytics</option>
          ...
          >
            ...
            <button
              type="submit"
              className="bg-green-500 text-gray-800 font-bold p-3 rounded-lg shadow-lg hover:bg-green-600 transition duration-300 w-40"
            >
              Submit
            </button>
          </form>
