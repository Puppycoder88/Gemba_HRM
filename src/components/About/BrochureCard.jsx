...
const BrochureCard = () => {
  return (
    ...
    <div className="bg-green-500 p-8 rounded-3xl text-white w-64 font-custom">
      ...
      <a href='/src/assets/Brochure.pdf' download='Brochure.pdf' className="bg-white text-blue-500 hover:bg-red-500 hover:text-white font-semibold py-2 px-2 rounded-3xl flex items-center justify-center">
