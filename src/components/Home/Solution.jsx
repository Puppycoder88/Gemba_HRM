  ...
  const SolutionsGrid = () => {
    return (
        <div className=" px-6 pt-10 ">
            <h1 className="text-blue-800 font-bold text-lg">WHAT WE DO ?</h1>
            <hr/>
            
            <p className="font-bold text-gray-700 text-4xl my-4">Transforming Ideas into Digital Realities</p>
